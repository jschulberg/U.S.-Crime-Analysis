...
Thus we predict that the crime rate in the new state would be 1248 crimes per 100,000 population. This seems within the range of reason for our data, especially given that the mean of our crime data is **`r mean(data$Crime)`** and the range goes from **`r range(data$Crime)[1]`** to **`r range(data$Crime)[2]`**.  
